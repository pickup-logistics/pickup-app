...
export const DriverLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigation is handled in the mutation based on user role
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">PickUp Rider</h1>
          <p className="text-gray-600 mt-2">Sign in to start earning</p>
        </div>
